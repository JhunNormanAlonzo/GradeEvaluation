                       ...
                       <form action="{{route('admin.student.update', [$student->id])}}" method="POST">
                        ...
                        @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-4 mb-sm-3">
                                    <x-input name="name" ph="Name" value="{{$student->user->name}}"></x-input>
                                    <x-validation name="name"></x-validation>
                                </div>

                                <div class="col-4 mb-sm-3">
                                    <x-input name="email" ph="Email" value="{{$student->user->email}}"></x-input>
                                    <x-validation name="email"></x-validation>
                                </div>

                                <div class="col-4 mb-sm-3">
                                    <x-input type="text" name="id_number" ph="ID Number" value="{{$student->id_number}}"></x-input>
                                    <x-validation name="id_number"></x-validation>
                                </div>
                                <div class="col-12 mb-sm-3">
                                    <textarea name="address" class="form-control" id="" rows="2" placeholder="Complete Address">{{$student->address}}</textarea>
